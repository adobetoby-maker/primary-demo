...
<p>Height and weight measurements allow your doctor to calculate your BMI (Body Mass Index). While BMI is not a perfect diagnostic tool, it helps identify whether weight trends are moving in a direction that warrants a conversation about nutrition, activity, or metabolic health.</p>

<p>Your physician will also conduct a head-to-toe physical exam — listening to your heart and lungs, examining your abdomen, checking lymph nodes, assessing your skin, and evaluating neurological reflexes. This hands-on assessment catches findings that lab work alone would miss.</p>

<h2>Bloodwork and Laboratory Screening</h2>

<p>Depending on your age and health history, your annual physical may include a blood panel drawn before your appointment. Standard panels typically include:</p>

<ul>
  <li><strong>Complete Blood Count (CBC):</strong> Screens for anemia, infection, and blood cell disorders.</li>
  <li><strong>Comprehensive Metabolic Panel (CMP):</strong> Evaluates kidney function, liver enzymes, blood sugar, and electrolytes.</li>
  <li><strong>Fasting Lipid Panel:</strong> Measures total cholesterol, LDL, HDL, and triglycerides. Elevated LDL and low HDL are independent risk factors for cardiovascular disease.</li>
  <li><strong>Hemoglobin A1c (HbA1c):</strong> Reflects your average blood sugar over the past three months. An A1c of 5.7 to 6.4 percent indicates prediabetes; 6.5 percent and above indicates diabetes.</li>
  <li><strong>Thyroid-Stimulating Hormone (TSH):</strong> Screens for thyroid dysfunction, which can cause fatigue, weight changes, mood shifts, and cardiovascular problems if untreated.</li>
</ul>

<h2>Cancer Screenings by Age</h2>

<p>Your annual physical exam is the right time to confirm you are up to date on age-appropriate cancer screenings. The most commonly recommended include:</p>

<ul>
  <li><strong>Colorectal cancer:</strong> Colonoscopy screening begins at age 45 for average-risk adults. Stool-based testing options are available for those who prefer a less invasive approach.</li>
  <li><strong>Cervical cancer:</strong> Pap smears are recommended every three years for women ages 21 to 65, or every five years when combined with HPV testing.</li>
  <li><strong>Breast cancer:</strong> Mammogram recommendations vary by risk level; current guidelines support annual mammograms starting at age 40 for average-risk women.</li>
  <li><strong>Lung cancer:</strong> Low-dose CT screening is recommended annually for adults ages 50 to 80 who have smoked 20 or more pack-years and currently smoke or quit within the last 15 years.</li>
  <li><strong>Skin cancer:</strong> Your physician will examine moles and skin lesions during the physical exam and refer to dermatology if any findings are concerning.</li>
</ul>
...
<p>Your body regulates blood sugar through insulin, a hormone produced by the pancreas. When you eat carbohydrates, blood glucose rises, and insulin signals cells to absorb that glucose for energy. Prediabetes occurs when cells become resistant to insulin's signal — a condition called insulin resistance. The pancreas compensates by producing more insulin, which masks the problem temporarily. Blood sugar remains elevated, but not yet at diabetic levels.</p>

<p>Clinically, prediabetes is defined by:</p>

<ul>
  <li><strong>Fasting blood glucose:</strong> 100 to 125 mg/dL (normal is below 100; diabetes is 126 and above)</li>
  <li><strong>Hemoglobin A1c:</strong> 5.7 to 6.4 percent (normal is below 5.7; diabetes is 6.5 and above)</li>
  <li><strong>Two-hour glucose tolerance test:</strong> 140 to 199 mg/dL</li>
</ul>

<p>A single abnormal result warrants follow-up. Two abnormal results on different days typically confirm the diagnosis.</p>
...
<ul>
  ...
  <li>First-degree relative with type 2 diabetes</li>
  <li>History of gestational diabetes or delivery of a baby weighing over 9 pounds</li>
  <li>Polycystic ovary syndrome (PCOS)</li>
  <li>High blood pressure (130/80 or higher)</li>
  <li>HDL cholesterol below 35 mg/dL or triglycerides above 250 mg/dL</li>
  <li>Physical inactivity</li>
  <li>History of cardiovascular disease</li>
</ul>

<p>Certain racial and ethnic groups — including Black, Hispanic, Asian American, Pacific Islander, and Native American individuals — carry higher risk independent of BMI and should be screened earlier and more frequently.</p>

<h2>The Evidence on Lifestyle Intervention</h2>

<p>This is where the science becomes genuinely encouraging. The Diabetes Prevention Program — a landmark clinical trial funded by the National Institutes of Health — enrolled over 3,000 adults with prediabetes and randomly assigned them to one of three groups: intensive lifestyle intervention, metformin, or placebo.</p>

<p>The results were striking. Lifestyle intervention — specifically, losing 5 to 7 percent of body weight through modest dietary changes and 150 minutes per week of moderate physical activity — reduced progression to type 2 diabetes by 58 percent. In adults over age 60, the reduction was even greater: 71 percent. Metformin reduced progression by 31 percent. The lifestyle approach was nearly twice as effective as medication alone.</p>

<p>Those numbers bear repeating: losing roughly 10 to 14 pounds for a 200-pound person, combined with 30 minutes of brisk walking five days per week, more than halved the risk of developing diabetes. These are not heroic interventions. They are achievable changes — especially with medical guidance and accountability from your prediabetes treatment team.</p>

<h2>The Role of Metformin</h2>

<p>Metformin is an oral medication that reduces glucose production in the liver and improves insulin sensitivity. While lifestyle intervention is more effective overall, metformin is an appropriate option for patients who have not responded sufficiently to lifestyle changes, patients with very high A1c levels within the prediabetes range, patients who are obese, and women with a history of gestational diabetes.</p>
...
<h2>Continuity of Care Is Not a Soft Benefit</h2>

<p>The relationship between a patient and their primary care physician accumulates value over time in ways that are difficult to replicate in episodic specialist visits. A family doctor who has seen you annually for ten years knows that your resting blood pressure runs 118/72 — so a reading of 140/88 is an alarm, not a baseline variation. They know that your father died of colon cancer at 58, that you lost 30 pounds three years ago and kept it off, that you tend to underreport symptoms because you do not want to seem like a hypochondriac.</p>
...
<p>When care is divided across multiple specialists without a primary care physician coordinating the full picture, several predictable problems emerge:</p>

<ul>
  <li><strong>Medication conflicts:</strong> A cardiologist prescribes a blood thinner. A rheumatologist prescribes an NSAID for joint pain. No one notices that the combination substantially increases bleeding risk — until there is a bleed.</li>
  <li><strong>Duplicate testing:</strong> Each specialist orders their own labs and imaging. Some tests are run three times. Others are never ordered because each specialist assumes another one covered it.</li>
  <li><strong>Communication gaps:</strong> Specialist visit notes take weeks to reach other providers, if they arrive at all. Decisions are made on incomplete information.</li>
  <li><strong>No one asking the big questions:</strong> In the cascade of specialist visits, no one has time to ask: How are you sleeping? Are you depressed? How is your stress level? These questions are not tangential — they are clinically relevant to almost every chronic condition.</li>
</ul>

<p>A family doctor serves as the hub of a care network — receiving specialist notes, reconciling medication lists, identifying gaps, and making sure all the pieces of your care are communicating with each other.</p>

<h2>Managing Chronic Conditions Over Time</h2>

<p>Consider type 2 diabetes. It requires monitoring of blood sugar, kidney function, eye health, foot health, blood pressure, and cholesterol. It interacts with every other condition a patient has. Its management changes over decades as the disease progresses and as the patient's life circumstances shift. A specialist can optimize insulin dosing. A family doctor can manage the whole picture — catching the early signs of diabetic nephropathy or retinopathy before they become irreversible, while also managing the hypertension that accelerates kidney damage and the depression that makes diabetes self-management harder to sustain.</p>

<p>This is the value proposition of primary care, and it is why health systems that invest in primary care infrastructure consistently produce better population health outcomes than those that prioritize specialist volume alone.</p>

<h2>The Right Referral at the Right Time</h2>

<p>None of this means specialists are unnecessary. The right model is a strong primary care relationship that coordinates specialist involvement when it is genuinely needed — not as a default for any symptom that touches a particular organ system. Dr. Rodriguez refers patients to specialists regularly and deliberately, with a clear clinical question being asked and a clear expectation that the information will return to inform ongoing primary care management.</p>
