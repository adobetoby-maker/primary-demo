...
export const metadata: Metadata = {
  title: 'Primary Care Services Twin Falls, ID | Dr. Lisa M. Patel',
  description:
    'Comprehensive primary care services in Twin Falls, Idaho: annual wellness exams, chronic disease management, preventive screenings, immunizations, urgent sick visits, and more.',
  alternates: {
  ...
  openGraph: {
    title: 'Primary Care Services Twin Falls, ID | Dr. Lisa M. Patel',
    description:
      'Comprehensive primary care services in Twin Falls, Idaho. Annual exams, chronic disease management, preventive screenings, immunizations, same-day sick visits.',
    url: `${SITE_URL}/services`,
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: 'Primary Care Services Twin Falls' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Primary Care Services Twin Falls, ID | Dr. Lisa M. Patel',
    description: 'Comprehensive primary care services in Twin Falls, Idaho. Accepting new patients.',
...
const services = [
  ...
  },
  {
    ...
    Icon: Brain,
    description:
      'Mental health is an inseparable part of overall health, and primary care is often the first — and most accessible — point of contact for patients experiencing depression, anxiety, or other behavioral health concerns. Dr. Patel screens for depression using the validated PHQ-9 and for anxiety using the GAD-7 at annual visits and whenever clinically indicated. She provides initial medication management for depression and anxiety, which is effective for many patients in a primary care setting. For patients requiring more intensive therapy or psychiatric care, she maintains a network of trusted behavioral health referral partners in the Twin Falls area and coordinates closely to ensure continuity of care. Suicidal ideation is addressed with immediate clinical attention and appropriate crisis resources.',
  },
  {
    slug: 'womens-health',
    name: "Women's Health",
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/70 mt-2 max-w-xl">
            Comprehensive primary care for every stage of life in Twin Falls, Idaho.
          </p>
        </div>
      </section>
